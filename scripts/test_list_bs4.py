...
from src.crawler.sources.x591.list_fetcher_bs4 import ListFetcherBs4


async def main(region: int, limit: int, raw: bool = False):
    """Run BS4 list fetch test."""
    print(f"\n{'=' * 60}")
    print("BS4 List Fetcher Test")
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Test BS4 list fetcher")
    parser.add_argument(
