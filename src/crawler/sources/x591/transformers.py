...
def transform_to_db_ready(combined: dict) -> DBReadyData:
    ...
    Example:
        ...
        8500
    """
    # Source identity: 591 listing id kept as-is (string) for source_id.
    # The UUID primary key is generated by the DB, not here.
    source_id = str(combined.get("id", "") or "").strip()
